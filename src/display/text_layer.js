define(['../shared/util.js'], function (a) {
    ...
    const renderTextLayer = function renderTextLayerClosure() {
        ...
        function appendText(task, geom, styles) {
            ...
            const tx = a.Util.transform(task._viewport.transform, geom.transform);
            ...
            if (task._enhanceTextSelection) {
                ...
                if (angle !== 0) {
                    ...
                    b = a.Util.getAxialAlignedBoundingBox([
                        0,
                        0,
                        divWidth,
                        divHeight
        ...
        function expand(task) {
            ...
            for (let i = 0; i < expanded.length; i++) {
                ...
                points.forEach(function (p, j) {
                    const t = a.Util.applyTransform(p, m);
        ...
        TextLayerRenderTask.prototype = {
            ...
            cancel: function TextLayer_cancel() {
                this._canceled = true;
                if (this._reader) {
                    this._reader.cancel(new a.AbortException('TextLayer task cancelled.'));
                    this._reader = null;
                }
