        ...
        fromIR: function Mesh_fromIR(raw) {
            ...
            return {
                getPattern: function Mesh_getPattern(ctx, owner, shadingFill) {
                    ...
                    let scale;
                    if (shadingFill) {
                        scale = a.Util.singularValueDecompose2dScale(ctx.mozCurrentTransform);
                    } else {
                        scale = a.Util.singularValueDecompose2dScale(owner.baseTransform);
                        if (matrix) {
                            const matrixScale = a.Util.singularValueDecompose2dScale(matrix);
                            scale = [
    ...
    const TilingPattern = function TilingPatternClosure() {
        ...
        TilingPattern.prototype = {
            createPatternCanvas: function TilinPattern_createPatternCanvas(owner) {
                ...
                a.info('TilingType: ' + tilingType);
                const x0 = bbox[0], y0 = bbox[1], x1 = bbox[2], y1 = bbox[3];
                const matrixScale = a.Util.singularValueDecompose2dScale(this.matrix);
                const curMatrixScale = a.Util.singularValueDecompose2dScale(this.baseTransform);
                const combinedScale = [
            ...
            setFillAndStrokeStyleToContext: function setFillAndStrokeStyleToContext(graphics, paintType, color) {
                ...
                case PaintType.UNCOLORED:
                    const cssColor = a.Util.makeHexColor(color[0], color[1], color[2]);
                    ...
                    break;
                default:
                    throw new a.FormatError(`Unsupported paint type: ${ paintType }`);
                }
            },
